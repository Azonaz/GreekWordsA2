...
enum Texts {
    ...
    static var quizGroups: String {
        NSLocalizedString("quizGroups", comment: "")
    }

    static var checkVerbs: String {
        NSLocalizedString("checkVerbs", comment: "")
    }
    ...
    static var reverseQuiz: String {
        NSLocalizedString("reverseQuiz", comment: "")
    }
